            ...
            <div class="content container-fluid">
                 <div class="row">
                    <div class="col-sm-4 col-5">
                        <h4 class="page-title">Categorías de gastos</h4>
                    </div>
                    <div class="col-sm-8 col-7 text-right m-b-30">
                        <a href="#" class="btn btn-primary btn-rounded pull-right" data-toggle="modal" data-target="#add_c_expencess"><i class="fa fa-plus"></i> Agregar Categoría</a>
                    </div>
                </div>
                <div class="row">                    
                     <div class="col-lg-12">                     
