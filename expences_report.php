...
function load(page){
    var daterange= $("#daterange").val();
        $("#loader").fadeIn('slow');
    $.ajax({
        url:'./ajax/expences_report.php?action=ajax&page='+page+'&daterange='+daterange,
...
// function print
    $("#data_income").submit(function(e){
     ...
     VentanaCentrada('./pdf/documentos/expences_report_pdf.php?daterange='+daterange,'Gasto','','1024','768','true');
    });
